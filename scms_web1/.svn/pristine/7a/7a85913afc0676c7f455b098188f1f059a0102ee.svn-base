...
public class BimUserApp {
    private Integer bimUseAppId;

    private Integer bimAppId;
    ...
    public Integer getBimUseAppId() {
        return bimUseAppId;
    }

    public void setBimUseAppId(Integer bimUseAppId) {
        this.bimUseAppId = bimUseAppId;
    }

    public Integer getBimAppId() {
        return bimAppId;
    }

    public void setBimAppId(Integer bimAppId) {
        this.bimAppId = bimAppId;
    }
