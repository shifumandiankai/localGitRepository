...
display:none!important;
	...
	<link rel="stylesheet" type="text/css" href="/pages/pfm/carmanage/css/car_manage.css" >
		...
		<div class="content-wrapper">
			...
			<li id="li5"><a href="#feerec" data-toggle="tab" id="a5">账户操作记录查询</a></li>
			</ul>						
			</div> 
...
<!--             aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa -->
           ...
           <select  name="carTypeId"  class="form-control">
            ...
            <div class="tab-pane fade " id="feerec">
            <form class="form-horizontal" id="form5">
             <input type="hidden" name ="order1">
            <input type="hidden" name ="order2">
            <div class="form-group">
            <div class="col-sm-4" style="padding-left:0px;">
            <div class="col-sm-4"><label>操作开始时间</label></div>
            <div class="col-sm-8">
            <div id ="startTimeNotice" class="point-out" style="width: 348px;top:-38px; left:0px; display: none;"></div>
            <input type="text" class="form-control"  name="startTime" onclick="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'2099-12-31'})">
            </div>
            ...
            <div class="col-sm-4">
            <div class="col-sm-4"><label  class=" control-label">操作结束时间</label></div>
            <div class="col-sm-8">
             <div id ="endTimeNotice" class="point-out" style="width: 348px;top:-38px; left:0px; display: none;"></div>
            <input type="text" class="form-control"   name="endTime" onclick="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'2099-12-31'})">
            </div>
            ...
            <div class="col-sm-4" style="padding-left:0px;">
            <div class="col-sm-4"><label  class=" control-label">操作类型</label></div>
            <div class="col-sm-8">
           ...
           <option value="1" >退款</option>
              ...
              <div class="col-sm-4" >
             <div class="col-sm-4"><label  class=" control-label">车辆性质</label></div>
             <div class="col-sm-8"> 
           <select  name="accountType"  class="form-control">
           <option value="-1" >无</option>
            <option value="0" >储值</option>
           <option value="1" >包期</option>
						...
						<table id="feerecexample" class="table table-bordered table-striped" >
							<thead>
								<tr>	
								<!-- (carNumber,direction,personName,carTypeName,parkName,entranceName,eventTime,carriagewayName,boothName,deviceName,cardId,userName) -->
	...
	<script type="text/javascript">
		...
		function Seepermission(){
			...
			//$("#chargerecordexample tbody td").text("请点击查询获取数据");
		}
	
		function drawInit(){
			
			$("#chargerecordexample tbody td").text("请点击查询获取数据");
			$("#normalexample tbody td").text("请点击查询获取数据");
			$("#abnormalexample tbody td").text("请点击查询获取数据");
			$("#parkreportexample tbody td").text("请点击查询获取数据");
			$("#feerecexample tbody td").text("请点击查询获取数据");
		} 
