...
public class BimUserDept {
    private Integer bimUseDeptId;
    ...
    public Integer getBimUseDeptId() {
        return bimUseDeptId;
    }

    public void setBimUseDeptId(Integer bimUseDeptId) {
        this.bimUseDeptId = bimUseDeptId;
    }
