		...
		if (getAllowOperate()) {
			...
			try {
             ...
             /*   sysConfigService.recordLog("备份数据库");*/
				...
				logRecord.recordLog(ConstParamLog.LOG_MODULE_BASIC_DATABASE, ConstParamLog.LOG_OPER_OTHER, ConstParamLog.LOG_TYPE_CTRL,"数据库备份");
		...
		if (getAllowOperate()) {
			...
			try {
				if (fileNames != null && fileNames.length == 1) {
					...
					logRecord.recordLog(ConstParamLog.LOG_MODULE_BASIC_DATABASE, ConstParamLog.LOG_OPER_OTHER, ConstParamLog.LOG_TYPE_CONFIG, "数据库还原");
