...
<div class="modal open" id="addcarType" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="form-group">
				<label class="col-sm-3 control-label">小车场权限</label>
				<div class="col-sm-8">
					<div id="noteNotice" class="point-out"
						style="width: 348px; top: -38px; left: 0px; display: none;"></div>
				<select type="text" class="form-control" name="custom3"></select>
				</div>
				</div>
			<div class="form-group">
						<label class="col-sm-3 control-label">小车场停放</label>
						<div class="col-sm-8">
							
							<select name="custom2" id="custom2" class="form-control">
								<option value="0">是</option>
								<option value="1">否</option>
