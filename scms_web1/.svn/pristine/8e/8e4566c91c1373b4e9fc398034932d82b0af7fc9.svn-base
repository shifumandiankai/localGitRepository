...
var config = $.extend({},{
	btns: new Array(
				{'id':"4001",'name':'审批',"fun":cancel_appley}),
	search:new Array({'type':'search','placeholder':'申请人/单号/车牌','url':null,'index':0}), //查询条件
	...
	columns: new Array(	//绑定数据的列
			"orderNum","personName","deptName","carNumber","useCarTime","useCarTimeLen","applayTime","note","personId","personCode","deptId","deptCode","status","carId","statusDes"),
	defs:new Array("personId","personCode","deptId","deptCode","carId","status","statusDes"),
