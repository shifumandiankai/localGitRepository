...
public class BimUserCate {
    private Integer bimUseCateId;
    ...
    public Integer getBimUseCateId() {
        return bimUseCateId;
    }

    public void setBimUseCateId(Integer bimUseCateId) {
        this.bimUseCateId = bimUseCateId;
    }
