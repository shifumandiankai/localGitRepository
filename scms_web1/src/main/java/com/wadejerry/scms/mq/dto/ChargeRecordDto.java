...
public class ChargeRecordDto {
	...
	public String toString() {
		return "ChargeRecordDto [chargeRecordId=" + chargeRecordId + ", carId=" + carId + ", carNumber=" + carNumber
				+ ", cardId=" + cardId + ", personName=" + personName + ", carTypeId=" + carTypeId + ", carTypeName="
				+ carTypeName + ", parkId=" + parkId + ", parkName=" + parkName + ", inEntranceId=" + inEntranceId
				...
				+ ", inUserId=" + inUserId + ", inUserName=" + inUserName + ", outEntranceId=" + outEntranceId
				+ ", outEntranceName=" + outEntranceName + ", outCarriagewayId=" + outCarriagewayId
				+ ", outCarriagewayName=" + outCarriagewayName + ", outBoothId=" + outBoothId + ", outBoothName="
				+ outBoothName + ", outDeviceId=" + outDeviceId + ", outDeviceName=" + outDeviceName + ", strOutTime="
				+ strOutTime + ", outPhoto=" + outPhoto + ", ruleId=" + ruleId + ", ruleName=" + ruleName
				+ ", ruleType=" + ruleType + ", parkingduration=" + parkingduration + ", chargefee=" + chargefee
				+ ", balance=" + balance + ", strDisableTime=" + strDisableTime + ", paymethod=" + paymethod
				+ ", jianmianfee=" + jianmianfee + ", jianmianrulename=" + jianmianrulename + ", note=" + note
				+ ", flag=" + flag + ", upload=" + upload + ", strInsertTime=" + strInsertTime + ", userId=" + userId
