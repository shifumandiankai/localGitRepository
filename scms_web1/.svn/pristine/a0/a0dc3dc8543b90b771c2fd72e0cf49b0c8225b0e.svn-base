...
public class BimUserRes {
    private Integer bimUseResId;

    private Integer bimResId;
    ...
    public Integer getBimUseResId() {
        return bimUseResId;
    }

    public void setBimUseResId(Integer bimUseResId) {
        this.bimUseResId = bimUseResId;
    }

    public Integer getBimResId() {
        return bimResId;
    }

    public void setBimResId(Integer bimResId) {
        this.bimResId = bimResId;
    }
