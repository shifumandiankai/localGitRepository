...
<div class="modal open" id="parkModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="form-horizontal"> 
         <input type="hidden" name ="pfmParkingLotId">
         <input type="hidden" name ="inId">
          ...
          <!-- <div class="form-group">
            ...
            <label for="recipient-name" class="control-label col-lg-3">预留车位</label>
            <div id="remainName" class="col-lg-9">
             <div id ="remainNumberNotice" class="point-out" style="width: 348px;top:-38px; left:0px; display: none;" name="remainNumberNotice"></div>
            <input type="text" class="form-control" id="recipient-name"  name ="reserveCarNumber">
            </div>
          </div> -->
           <div class="form-group">
