...
<link rel="stylesheet" type="text/css" href="/pages/pfm/carmanage/css/car_manage.css?<%=new Date().getTime() %>" >
		<div class="content-wrapper">
			<!-- Content Header (Page header) -->
			<section class="content-header">
			 
				<h1>
					<shiro:hasPermission name="CarManages"> 车辆信息界面</shiro:hasPermission>
				</h1>
				<ol class="breadcrumb">
					<li><a href="/index.do"><i class="fa fa-dashboard"></i>主页</a></li>
					<shiro:hasPermission name="CarManages"><li class="active">车辆信息</li></shiro:hasPermission>
				</ol>
			</section>
			<!-- Main content -->
	...
	<script  src="/pages/pfm/carmanage/js/car_manage.js?<%=new Date().getTime() %>" type="text/javascript"></script>
