...
public class PfmChargeRuleServiceImpl implements PfmChargeRuleService {
	...
	@Override
	@Transactional
	public OperateResult addFenShiRule(PfmChargeRule rule, PfmTimeCharge timecharge, List<PfmTimeChargeTime> timelist,PfmJianmianRelease reducerule,PfmJianmianRelease exceptionrule,PfmJianmianRelease mobileReducerule)
			throws Exception {
		...
		if(pcrnm.selectByCarTypeId(rule.getCarTypeId())>0){
			...
			addJianmianRule(mobileReducerule);
	...
	@Override
	@Transactional
	public OperateResult addFenShiDuanRule(PfmChargeRule rule, PfmPeriod period, List<PfmPeriodTime> timelist,PfmJianmianRelease reducerule,PfmJianmianRelease exceptionrule,PfmJianmianRelease mobileReducerule)
			throws Exception {
		OperateResult or = new OperateResult();
		if(pcrnm.selectByCarTypeId(rule.getCarTypeId())>0){
			or.setResult(false);
	...
	public OperateResult addFenDanweiShiDuanRule(PfmChargeRule rule, PfmUnitPeriod period,
			List<PfmUnitPeriodTime> timelist,PfmJianmianRelease reducerule,PfmJianmianRelease exceptionrule,PfmJianmianRelease mobileReducerule) throws Exception {
		OperateResult or = new OperateResult();
		if(pcrnm.selectByCarTypeId(rule.getCarTypeId())>0){
			or.setResult(false);
			or.setMsg("已有收费规则，添加失败");
...
//		}
	...
	public OperateResult updateFenshiRule(PfmChargeRule rule, PfmTimeCharge timecharge,
			List<PfmTimeChargeTime> timelist,PfmJianmianRelease reducerule,PfmJianmianRelease exceptionrule,PfmJianmianRelease mobileReducerule) throws Exception {
		...
		OperateResult or = new OperateResult();
			...
			updateJianmianRule(mobileReducerule);
			or.setResult(true);
	...
	@Override
	@Transactional
	public OperateResult updateFenshiDuanRule(PfmChargeRule rule, PfmPeriod period, List<PfmPeriodTime> timelist,PfmJianmianRelease reducerule,PfmJianmianRelease exceptionrule,PfmJianmianRelease mobileReducerule)
			throws Exception {
		OperateResult or = new OperateResult();
