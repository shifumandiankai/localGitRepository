...
//				}
	...
	@Override
	public List<Map<String, Object>> download(int companyid,String carTypeId,String orderby,String searchVal) {
		...
		if(!"".equals(carTypeId.trim())){
			carType=Integer.parseInt(carTypeId.trim());
		}
		List<Integer> cartypeids = authority.carTypeAuth();
		return  pcim.selectExcel(companyid,carType,cartypeids,orderby,searchVal);
