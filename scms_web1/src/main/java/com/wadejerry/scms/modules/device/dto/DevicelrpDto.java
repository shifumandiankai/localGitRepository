package com.wadejerry.scms.modules.device.dto;

import java.util.Date;

public class DevicelrpDto {
...
public String getCongfigsel() {
	return congfigsel;
}
public void setCongfigsel(String congfigsel) {
	this.congfigsel = congfigsel;
}
